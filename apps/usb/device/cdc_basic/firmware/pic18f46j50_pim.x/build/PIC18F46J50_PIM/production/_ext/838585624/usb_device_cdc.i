# 1 "../../../../../../framework/usb/src/usb_device_cdc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../../../framework/usb/src/usb_device_cdc.c" 2
# 48 "../../../../../../framework/usb/src/usb_device_cdc.c"
# 1 ".\\system.h" 1
# 23 ".\\system.h"
...
# 16193 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\pic18f46j50.h" 3
...
# 16384 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\pic18f46j50.h" 3
...
# 1 "../../../../../../bsp/pic18f46j50_pim\\buttons.h" 1
# 29 "../../../../../../bsp/pic18f46j50_pim\\buttons.h"
typedef enum
{
    BUTTON_NONE,
    BUTTON_S2,
...
# 52 "../../../../../../bsp/pic18f46j50_pim\\buttons.h"
_Bool BUTTON_IsPressed(BUTTON button);
# 70 "../../../../../../bsp/pic18f46j50_pim\\buttons.h"
void BUTTON_Enable(BUTTON button);
# 26 ".\\system.h" 2

# 1 "../../../../../../bsp/pic18f46j50_pim\\leds.h" 1
# 29 "../../../../../../bsp/pic18f46j50_pim\\leds.h"
typedef enum
{
    LED_NONE,
    LED_D1,
...
# 54 "../../../../../../bsp/pic18f46j50_pim\\leds.h"
void LED_On(LED led);
# 72 "../../../../../../bsp/pic18f46j50_pim\\leds.h"
void LED_Off(LED led);
# 90 "../../../../../../bsp/pic18f46j50_pim\\leds.h"
void LED_Toggle(LED led);
# 108 "../../../../../../bsp/pic18f46j50_pim\\leds.h"
_Bool LED_Get(LED led);
# 125 "../../../../../../bsp/pic18f46j50_pim\\leds.h"
...
# 48 "../../../../../../framework/usb/src/usb_device_cdc.c" 2
...
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\limits.h" 1 3
# 10 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\limits.h" 3
...
# 48 "../../../../../../framework/usb/inc/usb_common.h" 2
...
# 49 "../../../../../../framework/usb/src/usb_device_cdc.c" 2

# 1 "../../../../../../framework/usb/inc\\usb_device_cdc.h" 1
# 536 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void CDCInitEP(void);
# 562 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void USBCheckCDCRequest(void);
# 580 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void CDCNotificationHandler(void);
# 606 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
_Bool USBCDCEventHandler(USB_EVENT event, void *pdata, uint16_t size);
# 653 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
uint8_t getsUSBUSART(uint8_t *buffer, uint8_t len);
# 695 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void putUSBUSART(uint8_t *data, uint8_t Length);
# 736 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void putsUSBUSART(char *data);
# 779 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void putrsUSBUSART(const char *data);
# 831 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
void CDCTxService(void);
# 844 "../../../../../../framework/usb/inc\\usb_device_cdc.h"
...
# 50 "../../../../../../framework/usb/src/usb_device_cdc.c" 2
# 66 "../../../../../../framework/usb/src/usb_device_cdc.c"
...
uint8_t cdc_rx_len;
uint8_t cdc_trf_state;
POINTER pCDCSrc;
POINTER pCDCDst;
uint8_t cdc_tx_len;
uint8_t cdc_mem_type;
...
# 111 "../../../../../../framework/usb/src/usb_device_cdc.c"
uint8_t dummy_encapsulated_cmd_response[0x08];
...
# 148 "../../../../../../framework/usb/src/usb_device_cdc.c"
void USBCheckCDCRequest(void)
{
    ...
    switch(SetupPkt.bRequest)
    {
        ...
        case 0x20:
            ...
            outPipes[0].pDst.bRam = (uint8_t*)&line_coding._byte[0];
            outPipes[0].pFunc = ((void*)0);
            outPipes[0].info.bits.busy = 1;
            break;

        case 0x21:
            { inPipes[0].pSrc.bRam = (uint8_t*)&line_coding; inPipes[0].wCount.Val = 0x07; inPipes[0].info.Val = 0x40 | 0x80 | 0x01; };
...
# 232 "../../../../../../framework/usb/src/usb_device_cdc.c"
            inPipes[0].info.bits.busy = 1;
            break;
# 257 "../../../../../../framework/usb/src/usb_device_cdc.c"
        default:
            break;
    }

}
# 295 "../../../../../../framework/usb/src/usb_device_cdc.c"
void CDCInitEP(void)
{
    ...
    cdc_rx_len = 0;
# 316 "../../../../../../framework/usb/src/usb_device_cdc.c"
    USBEnableEndpoint(1,0x02|0x10|0x08);
    USBEnableEndpoint(2,0x02|0x04|0x10|0x08);

    CDCDataOutHandle = USBTransferOnePacket(2,0,(uint8_t*)&cdc_data_rx,sizeof(cdc_data_rx));
    CDCDataInHandle = ((void*)0);
# 347 "../../../../../../framework/usb/src/usb_device_cdc.c"
    cdc_trf_state = 0;
}
# 425 "../../../../../../framework/usb/src/usb_device_cdc.c"
_Bool USBCDCEventHandler(USB_EVENT event, void *pdata, uint16_t size)
{
...
# 486 "../../../../../../framework/usb/src/usb_device_cdc.c"
uint8_t getsUSBUSART(uint8_t *buffer, uint8_t len)
{
    cdc_rx_len = 0;

    if(!((CDCDataOutHandle != 0x0000) && ((*(volatile uint8_t*)CDCDataOutHandle & 0x80) != 0x00)))
    {
...
# 557 "../../../../../../framework/usb/src/usb_device_cdc.c"
void putUSBUSART(uint8_t *data, uint8_t length)
{
# 582 "../../../../../../framework/usb/src/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state == 0)
    {
...
# 630 "../../../../../../framework/usb/src/usb_device_cdc.c"
void putsUSBUSART(char *data)
{
    uint8_t len;
    char *pData;
# 658 "../../../../../../framework/usb/src/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state != 0)
    {
        {PIE2bits.USBIE = 1;};
...
# 727 "../../../../../../framework/usb/src/usb_device_cdc.c"
void putrsUSBUSART(const char *data)
{
    uint8_t len;
    const char *pData;
# 755 "../../../../../../framework/usb/src/usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state != 0)
    {
        {PIE2bits.USBIE = 1;};
...
void CDCTxService(void)
{
    ...
    if(((CDCDataInHandle != 0x0000) && ((*(volatile uint8_t*)CDCDataInHandle & 0x80) != 0x00)))
    {
        {PIE2bits.USBIE = 1;};
        return;
    }
    ...
    if(cdc_trf_state == 2)
    {
        CDCDataInHandle = USBTransferOnePacket(2,1,((void*)0),0);
    ...
    else if(cdc_trf_state == 1)
    {
     ...
     cdc_tx_len = cdc_tx_len - byte_to_send;
        ...
        CDCDataInHandle = USBTransferOnePacket(2,1,(uint8_t*)&cdc_data_tx,byte_to_send);
