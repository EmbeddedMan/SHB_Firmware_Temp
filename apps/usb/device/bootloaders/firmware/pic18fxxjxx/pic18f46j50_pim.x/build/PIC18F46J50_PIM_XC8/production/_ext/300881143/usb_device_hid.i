...
# 2 "<built-in>" 2
# 1 "../demo_src/usb_device_hid.c" 2
# 21 "../demo_src/usb_device_hid.c"
# 1 "../demo_src/usb.h" 1
# 30 "../demo_src/usb.h"
...
# 21 "../demo_src/usb_device_hid.c" 2
...
unsigned char active_protocol;
unsigned char hid_rpt_rx_len;


void HIDGetReportHandler(void);
void HIDSetReportHandler(void);
# 59 "../demo_src/usb_device_hid.c"
void USBCheckHIDRequest(void)
{
    if(SetupPkt.Recipient != 1) return;
    ...
    if(SetupPkt.bRequest == 6)
    {
        ...
        {
            case 0x21:
                ctrl_trf_session_owner = 2;
                pSrc.bRom = &CFG01[18];
                wCount.Val = sizeof(USB_HID_DSC);
                break;
            case 0x22:
                ctrl_trf_session_owner = 2;
                { if(usb_active_cfg == 1) pSrc.bRom = (const unsigned char*)&hid_rpt01; };
                { if(usb_active_cfg == 1) wCount.Val = sizeof(hid_rpt01); };
                break;
            case 0x23:
    ...
    if(SetupPkt.RequestType != 0x01) return;
    switch(SetupPkt.bRequest)
    {
        ...
        case 0x02:
            ctrl_trf_session_owner = 2;
            pSrc.bRam = (unsigned char*)&idle_rate;
        ...
        case 0x03:
            ctrl_trf_session_owner = 2;
            pSrc.bRam = (unsigned char*)&active_protocol;
            usb_stat.ctrl_trf_mem = 0;
            wCount.v[0] = 1;
            break;
        case 0x0B:
...
void HIDInitEP(void)
{
    ...
    ep1Bo.Cnt = sizeof(hid_report_out);
    ep1Bo.ADR = (unsigned char*)&hid_report_out;
    ep1Bo.Stat._byte = 0x00|0x08;
    ep1Bo.Stat._byte |= 0x80;
# 180 "../demo_src/usb_device_hid.c"
    ep1Bi.ADR = (unsigned char*)&hid_report_in;
    ep1Bi.Stat._byte = 0x00|0x40;

}
# 215 "../demo_src/usb_device_hid.c"
void HIDTxReport(char *buffer, unsigned char len)
{
    unsigned char i;
    ...
    ep1Bi.Cnt = len;
    { ep1Bi.Stat._byte &= 0x40; ep1Bi.Stat.DTS = !ep1Bi.Stat.DTS; ep1Bi.Stat._byte |= 0x08; ep1Bi.Stat._byte |= 0x80; };

}
# 270 "../demo_src/usb_device_hid.c"
unsigned char HIDRxReport(char *buffer, unsigned char len)
{
    hid_rpt_rx_len = 0;
    ...
    if(!ep1Bo.Stat.UOWN)
    {
        ...
        ep1Bo.Cnt = sizeof(hid_report_out);
        { ep1Bo.Stat._byte &= 0x40; ep1Bo.Stat.DTS = !ep1Bo.Stat.DTS; ep1Bo.Stat._byte |= 0x08; ep1Bo.Stat._byte |= 0x80; };
    }
